...
class TreeValueWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt;\">Выберите переменные для Решающего дерева:</span></p></body></html>"))
