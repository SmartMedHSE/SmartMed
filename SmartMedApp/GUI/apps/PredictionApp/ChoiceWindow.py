...
class ChoiceWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow",
                                      "<html><head/><body><p><span style=\" font-size:18pt;\">Для начала основого этапа выберите</span></p><p><span style=\" font-size:18pt;\"> одну из регрессионных моделей:</span></p></body></html>"))
