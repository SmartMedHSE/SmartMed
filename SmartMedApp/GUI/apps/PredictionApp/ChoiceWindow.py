...
class ChoiceWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(70, 30, 500, 90))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:17pt;\">Для начала основого этапа выберите</span></p><p><span style=\" font-size:17pt;\"> одну из регрессионных моделей:</span></p></body></html>"))
