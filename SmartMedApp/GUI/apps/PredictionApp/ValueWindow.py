...
class ValueWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(70, 30, 500, 80))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:17pt;\">Выберите зависимую переменную:</span></p><p><span style=\" font-size:17pt;\"> из списка:</span></p></body></html>"))
