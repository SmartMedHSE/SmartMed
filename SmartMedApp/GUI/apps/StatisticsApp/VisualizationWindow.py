...
class VisualizationWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkBeforeAfter = QtWidgets.QCheckBox(self.verticalLayoutWidget)
        self.checkMultiHist.setObjectName("checkBeforeAfter")
        self.verticalLayout.addWidget(self.checkBeforeAfter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBeforeAfter.setText(_translate("MainWindow", " Наклонная карта"))
