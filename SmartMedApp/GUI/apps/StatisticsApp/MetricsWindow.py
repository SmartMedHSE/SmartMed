...
class MetricsWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow",
                                      "<html><head/><body><p><span style=\" font-size:18pt;\">Выбор статистических метрик</span></p></body></html>"))
        ...
        self.checkBoxStd.setToolTip(
            _translate("MainWindow", "<html><head/><body><p>Показывает разброс значений в столбце</p></body></html>"))
        ...
        self.checkBoxQuants.setToolTip(_translate("MainWindow",
                                                  "<html><head/><body><p>По этим значениям можно оценить распределение выборки</p><p><br/></p></body></html>"))
