...
class DownloadWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow",
                                        "<html><head/><body><p><span style=\" font-size:12pt;\">Данные по тестовому препарату</span></p></body></html>"))
        self.label_4.setText(_translate("MainWindow",
                                        "<html><head/><body><p><span style=\" font-size:12pt;\">Данные по референсному препарату</span></p><p><span style=\" font-size:12pt;\"><br/></span></p></body></html>"))
