...
class NormalityWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(70, 30, 500, 81))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:17pt;\">Выберите способ проверки данных </span></p><p><span style=\" font-size:18pt;\"> на нормальность</span></p></body></html>"))
