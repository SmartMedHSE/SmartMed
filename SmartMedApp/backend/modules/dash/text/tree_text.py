markdown_tree_graph = '''
    ...
    Если условие неравенства выполняется, то образец идет в левый узел, иначе - в правый.
'''
...
markdown_introduction = '''
    ...
    классу. 
    Собственно, само дерево решений — это метод представления решающих правил в иерархической структуре,
    состоящей из элементов двух типов — узлов (node) и листьев (leaf). В узлах находятся решающие правила и
